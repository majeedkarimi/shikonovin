...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shikonovin_products', '0001_initial'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='image',
            field=models.ImageField(blank=True, null=True, upload_to=shikonovin_products.models.upload_image_path, verbose_name='تصویر '),
        ),
        migrations.AlterField(
            model_name='product',
            name='price',
